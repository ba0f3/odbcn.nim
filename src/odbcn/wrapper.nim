...
## Wrapper of ODBC C API modified for the odbcn library.

from std/winlean import GUID
export GUID
...
type
  OdbcDate* {.final, pure.} = object
    year*: TSqlSmallInt
    month*: TSqlUSmallInt
    day*: TSqlUSmallInt

  OdbcTime* {.final, pure.} = object
    hour*: TSqlUSmallInt
    minute*: TSqlUSmallInt
    second*: TSqlUSmallInt

  OdbcTimestamp* {.final, pure.} = object
    year*: TSqlSmallInt
    month*: TSqlUSmallInt
    day*: TSqlUSmallInt
    hour*: TSqlUSmallInt
...
const
  ...
  SQL_CP_OFF* = 0'u64
  SQL_CP_ONE_PER_DRIVER* = 1'u64
  SQL_CP_ONE_PER_HENV* = 2'u64
  #SQL_USER_NAME* = 47
...
proc SQLGetDiagRec*(HandleType: TSqlSmallInt, Handle: SqlHandle,
                    RecNumber: TSqlSmallInt, Sqlstate: ptr TSqlChar,
                    NativeError: var TSqlInteger, MessageText: ptr TSqlChar,
...
proc SQLGetDiagField*(HandleType: TSqlSmallInt, Handle: SqlHandle,
    ...
    dynlib: odbclib, importc.}
proc SQLConnect*(ConnectionHandle: SqlHDBC, ServerName: cstring,
                 NameLength1: TSqlSmallInt, UserName: cstring,
                 NameLength2: TSqlSmallInt, Authentication: cstring,
...
proc SQLDriverConnect*(hdbc: SqlHDBC, hwnd: SqlHWND, szCsin: cstring,
                       szCLen: TSqlSmallInt, szCsout: ptr TSqlChar,
                       cbCSMax: TSqlSmallInt, cbCsOut: ptr TSqlSmallInt,
                       f: TSqlUSmallInt): TSqlSmallInt{.dynlib: odbclib, importc.}
proc SQLBrowseConnect*(hdbc: SqlHDBC, szConnStrIn: cstring,
                       cbConnStrIn: TSqlSmallInt, szConnStrOut: ptr TSqlChar,
                       cbConnStrOutMax: TSqlSmallInt,
                       cbConnStrOut: var TSqlSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLExecDirect*(StatementHandle: SqlHStmt, StatementText: cstring,
                    TextLength: TSqlInteger): TSqlSmallInt{.dynlib: odbclib, importc.}
proc SQLExecDirectW*(StatementHandle: SqlHStmt, StatementText: ptr TSqlWChar,
                    TextLength: TSqlInteger): TSqlSmallInt{.dynlib: odbclib, importc.}
proc SQLPrepare*(StatementHandle: SqlHStmt, StatementText: cstring,
                 TextLength: TSqlInteger): TSqlSmallInt{.dynlib: odbclib, importc.}
proc SQLPrepareW*(StatementHandle: SqlHStmt, StatementText: ptr TSqlWChar,
                 TextLength: TSqlInteger): TSqlSmallInt{.dynlib: odbclib, importc.}
...
proc SQLNumResultCols*(StatementHandle: SqlHStmt, ColumnCount: var TSqlSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLNumParams*(hstmt: SqlHStmt; pcpar: var TSqlSmallInt): TSqlSmallInt {.dynlib: odbclib, importc.}
proc SQLDescribeCol*(StatementHandle: SqlHStmt, ColumnNumber: TSqlUSmallInt,
                     ColumnName: ptr TSqlChar, BufferLength: TSqlSmallInt,
...
proc SQLFetchScroll*(StatementHandle: SqlHStmt, FetchOrientation: TSqlSmallInt,
    ...
    importc.}
proc SQLExtendedFetch*(hstmt: SqlHStmt, fFetchType: TSqlUSmallInt,
                       irow: TSqlLen, pcrow: var TSqlULen,
                       rgfRowStatus: ptr TSqlUSmallInt): TSqlSmallInt{.dynlib: odbclib,
    importc.}
proc SQLGetData*(StatementHandle: SqlHStmt, ColumnNumber: TSqlUSmallInt,
                 TargetType: TSqlSmallInt, TargetValue: SqlPointer,
                 BufferLength: TSqlLen, StrLen_or_Ind: ptr TSqlLen): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLGetInfo*(ConnectionHandle: SqlHDBC, InfoType: TSqlUSmallInt,
                 InfoValue: SqlPointer, BufferLength: TSqlSmallInt,
                 StringLength: ptr TSqlSmallInt): TSqlSmallInt{.dynlib: odbclib,
    importc.}
proc SQLGetConnectAttr*(ConnectionHandle: SqlHDBC; Attribute: TSqlInteger;
                        Value: SqlPointer; BufferLength: TSqlInteger;
                        StringLength: ptr TSqlInteger): TSqlSmallInt {.dynlib: odbclib, importc.}
...
proc SQLSetConnectAttr*(ConnectionHandle: SqlHDBC; Attribute: TSqlInteger;
                        Value: SqlPointer; StringLength: TSqlInteger): TSqlSmallInt {.dynlib: odbclib, importc.}
...
proc SQLSetStmtAttr*(StatementHandle: SqlHStmt; Attribute: TSqlInteger;
                        Value: SqlPointer; StringLength: TSqlInteger): TSqlSmallInt {.dynlib: odbclib, importc.}
proc SQLBulkOperations*(StatementHandle: SqlHStmt, Operation: TSqlUSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
...
proc SQLDataSources*(EnvironmentHandle: SqlHEnv, Direction: TSqlUSmallInt,
                     ServerName: ptr TSqlChar, BufferLength1: TSqlSmallInt,
                     NameLength1: var TSqlSmallInt, Description: ptr TSqlChar,
                     BufferLength2: TSqlSmallInt, NameLength2: var TSqlSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLDrivers*(EnvironmentHandle: SqlHEnv, Direction: TSqlUSmallInt,
                 DriverDescription: ptr TSqlChar, BufferLength1: TSqlSmallInt,
                 DescriptionLength1: ptr TSqlSmallInt, DriverAttributes: ptr TSqlChar,
                 BufferLength2: TSqlSmallInt, AttributesLength2: ptr TSqlSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLGetCursorName*(StatementHandle: SqlHStmt, CursorName: ptr TSqlChar,
                       BufferLength: TSqlSmallInt, NameLength: ptr TSqlSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLSetCursorName*(StatementHandle: SqlHStmt, CursorName: ptr TSqlChar,
...
proc SQLBindParameter*(hstmt: SqlHStmt, ipar: TSqlUSmallInt,
    ...
    dynlib: odbclib, importc.}
proc SQLFreeStmt*(StatementHandle: SqlHStmt, Option: TSqlUSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLColAttribute*(StatementHandle: SqlHStmt, ColumnNumber: TSqlUSmallInt,
                      FieldIdentifier: TSqlUSmallInt,
                      CharacterAttribute: ptr TSqlChar, BufferLength: TSqlSmallInt,
                      StringLength: ptr TSqlSmallInt,
...
proc SQLEndTran*(HandleType: TSqlSmallInt, Handle: SqlHandle,
    ...
    importc.}
proc SQLTables*(hstmt: SqlHStmt, szTableQualifier: cstring,
                cbTableQualifier: TSqlSmallInt, szTableOwner: cstring,
                cbTableOwner: TSqlSmallInt, szTableName: cstring,
                cbTableName: TSqlSmallInt, szTableType: cstring,
                cbTableType: TSqlSmallInt): TSqlSmallInt{.dynlib: odbclib, importc.}
proc SQLColumns*(hstmt: SqlHStmt, szTableQualifier: cstring,
                 cbTableQualifier: TSqlSmallInt, szTableOwner: cstring,
                 cbTableOwner: TSqlSmallInt, szTableName: cstring,
                 cbTableName: TSqlSmallInt, szColumnName: cstring,
                 cbColumnName: TSqlSmallInt): TSqlSmallInt{.dynlib: odbclib, importc.}
proc SQLSpecialColumns*(StatementHandle: SqlHStmt, IdentifierType: TSqlUSmallInt,
                        CatalogName: cstring, NameLength1: TSqlSmallInt,
                        SchemaName: cstring, NameLength2: TSqlSmallInt,
                        TableName: cstring, NameLength3: TSqlSmallInt,
                        Scope: TSqlUSmallInt,
                        Nullable: TSqlUSmallInt): TSqlSmallInt{.
    dynlib: odbclib, importc.}
proc SQLProcedures*(hstmt: SqlHStmt, szTableQualifier: cstring,
                    cbTableQualifier: TSqlSmallInt, szTableOwner: cstring,
                    cbTableOwner: TSqlSmallInt, szTableName: cstring,
                    cbTableName: TSqlSmallInt): TSqlSmallInt{.dynlib: odbclib,
    importc.}
proc SQLPrimaryKeys*(hstmt: SqlHStmt, CatalogName: cstring,
                     NameLength1: TSqlSmallInt, SchemaName: cstring,
                     NameLength2: TSqlSmallInt, TableName: cstring,
                     NameLength3: TSqlSmallInt): TSqlSmallInt{.dynlib: odbclib,
    importc.}
proc SQLProcedureColumns*(hstmt: SqlHStmt, CatalogName: cstring,
                          NameLength1: TSqlSmallInt, SchemaName: cstring,
                          NameLength2: TSqlSmallInt, ProcName: cstring,
                          NameLength3: TSqlSmallInt, ColumnName: cstring,
                          NameLength4: TSqlSmallInt): TSqlSmallInt{.dynlib: odbclib,
    importc.}
proc SQLStatistics*(hstmt: SqlHStmt, CatalogName: cstring,
                    NameLength1: TSqlSmallInt, SchemaName: cstring,
                    NameLength2: TSqlSmallInt, TableName: cstring,
                    NameLength3: TSqlSmallInt, Unique: TSqlUSmallInt,
                    Reserved: TSqlUSmallInt): TSqlSmallInt {.
                    dynlib: odbclib, importc.}
proc SQLTablePrivileges*(hstmt: SqlHStmt; szCatalogName: cstring;
                         cbCatalogName: TSqlSmallInt;
                         szSchemaName: cstring; cbSchemaName: TSqlSmallInt;
                         szTableName: cstring; cbTableName: TSqlSmallInt): TSqlSmallInt {.dynlib: odbclib, importc.}
proc SQLColumnPrivileges*(hstmt: SqlHStmt; szCatalogName: cstring;
                          cbCatalogName: TSqlSmallInt;
                          szSchemaName: cstring;
                          cbSchemaName: TSqlSmallInt; szTableName: cstring;
                          cbTableName: TSqlSmallInt; szColumnName: cstring;
                          cbColumnName: TSqlSmallInt): TSqlSmallInt {.dynlib: odbclib, importc.}
proc SQLForeignKeys*(hstmt: SqlHStmt; szPkCatalogName: cstring;
                     cbPkCatalogName: TSqlSmallInt;
                     szPkSchemaName: cstring; cbPkSchemaName: TSqlSmallInt;
                     szPkTableName: cstring; cbPkTableName: TSqlSmallInt;
                     szFkCatalogName: cstring;
                     cbFkCatalogName: TSqlSmallInt;
                     szFkSchemaName: cstring; cbFkSchemaName: TSqlSmallInt;
                     szFkTableName: cstring; cbFkTableName: TSqlSmallInt): TSqlSmallInt {.dynlib: odbclib, importc.}
proc SQLMoreResults*(hstmt: SqlHStmt): TSqlSmallInt {.dynlib: odbclib, importc.}
